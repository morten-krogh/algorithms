...
import { Sha3_512 } from "../src/sha3-512.js";
...
test("sha3-512.js has no Node-only imports or Buffer dependency", async (_t) => {
	const source = await readFile(
		new URL("../src/sha3-512.js", import.meta.url),
		"utf8",
	);
...
test("sha3-512.js only exports Sha3_512", async (_t) => {
	const fresh = await import(`../src/sha3-512.js?exports=${Date.now()}`);
